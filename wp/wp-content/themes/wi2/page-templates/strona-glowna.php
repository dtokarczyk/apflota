    ...
    <div class="overflowHidden">
        <div class="containerBig">
            <div class="section50x50">
                <?php while( have_rows("o_nas_-_5050",wpmlID(2)) ) { the_row(); ?>
                    <div class="section50x50box displayFlex flexWrap flexXstart flexYcenter ceAnimateUP">
                        ...
                        <div class="section50x50boxImg"><img data-src="<?php $zdjecie = get_sub_field('zdjecie'); echo $zdjecie["sizes"]["ce_img-704xX"]; ?>" alt="img" class="img-full lazy" /></div>
                    </div>
                <?php } ?>
            </div>
        </div>
            ...
            <div class="sectionTable ceAnimateUP">
                <table class="sectionTableBox">
                    <?php if( have_rows("tabela",wpmlID(2)) ) { ?>
                        <?php while( have_rows("tabela",wpmlID(2)) ) { the_row(); ?>
...
<?php if(get_field('sekcja_5050_-_on__off',wpmlID(2)) != 1) { ?>
    <div class="overflowHidden">
        <div class="containerBig">
            <div class="section50x50">
                <?php while( have_rows("sekcja_5050",wpmlID(2)) ) { the_row(); ?>
    ...
    <div id="sectionLogotype">
        <div class="containerBig">
            ...
            <div class="sectionLogotypeBox ceAnimateUP">
                <?php if( have_rows("zaufali_nam",wpmlID(2)) ) { $i=1; ?>
                    <?php while( have_rows("zaufali_nam",wpmlID(2)) ) { the_row(); ?>
