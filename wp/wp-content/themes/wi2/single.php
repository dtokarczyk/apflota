            ...
            <div class="sectioOfferItem">
                <span class="sectionOfferItemDesc1 displayFlex flexWrap flexXstart flexYcenter">
                    <span class="displayFlex flexXcenter flexYcenter">
                        ...
                        <?php $rodzajePaliwa = get_the_terms(get_the_ID(), 'rodzaj-paliwa'); echo $rodzajePaliwa[0]->name;?>
                    </span>
                    <span class="displayFlex flexXcenter flexYcenter">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/gearbox.svg" alt="gearbox">
                        <?php $skrzynieBiegowDo = get_the_terms(get_the_ID(), 'skrzynia-biegow'); echo $skrzynieBiegowDo[0]->name; ?>
                    </span>
                    <span class="displayFlex flexXcenter flexYcenter">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/segment.svg" alt="segment">
                        <?php $segmenty = get_the_terms(get_the_ID(), 'segment'); echo $segmenty[0]->name; ?>
                    </span>
                </span>
            </div>
            <div class="sectioOfferItem">
                <div class="sectioOfferGallery">
                    <div class="sectioOfferGalleryBox">
                        <?php $images = ""; $images = get_field('galeria'); ?>
                        <?php if($images) { ?>
                ...
                <?php if(have_rows("informacje_podstawowe")) { ?> 
                    <div class="sectioOfferInformation">
                        ...
                        <div class="sectioOfferInformationBox displayFlex flexWrap flexXstart flexYcenter">
                            <?php while( have_rows("informacje_podstawowe") ) { the_row(); ?>
                    ...
                    <div id="contentEditor">
                        <div class="ceFilesDownload">
                            ...
                            <div class="sectionAttachments sectionProductAttachments">
                                <?php while( have_rows("do_pobrania") ) { the_row(); ?>
            ...
            <div class="sectioOfferItem">
                <?php if(get_field('csv',wpmlID(2)) != "") { ?>
                    <div class="sectioOfferCalc" carid="<?php echo get_field('id'); ?>">
                        ...
                        <div class="sectioOfferCalcTitle"><?php echo get_field('kalkulator_-_oplata_wstepna',wpmlID(2)); ?> <div class="sectioOfferCalcFee" zl="<?php echo __("zł","wi"); ?>">(<span>----</span><?php echo __("zł","wi"); ?>)</div></div>
                        <div class="sectioOfferCalcPercent buttonCalcContainer displayFlex flexXcenter flexYcenter">
                            <div class="buttonCalc displayFlex flexXcenter flexYcenter"><span class="val val0" value="0">0</span><span class="ins">%</span></div>
                            <div class="buttonCalc displayFlex flexXcenter flexYcenter"><span class="val val10" value="10">10</span><span class="ins">%</span></div>
                            <div class="buttonCalc buttonCalcActive displayFlex flexXcenter flexYcenter"><span class="val val20" value="20">20</span><span class="ins">%</span></div>
                        </div>
...
<div id="sectionOffer">
    <div class="containerBig">
        <div class="sectionOfferTitle">
            <p style="text-align: center;"><span class="overTitle"><?php echo __("Oferta","wi"); ?></span></p>
            <h3 style="text-align: center;"><?php echo __("Zobacz inne oferty","wi"); ?></h3>
            <p style="text-align: center;"></p><div class="spaceRegular"></div><p></p>
        </div>
