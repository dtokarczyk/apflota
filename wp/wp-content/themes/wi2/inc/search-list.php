    ...
    <?php } elseif($_GET["order"] == "pl") { ?>  
        <?php $args = array('post_type' => 'post', 'posts_per_page' => '-1', 'meta_key' => 'cena_od', 'orderby' => 'meta_value', 'order' => 'ASC'); ?>
    <?php } elseif($_GET["order"] == "ph") { ?>  
        <?php $args = array('post_type' => 'post', 'posts_per_page' => '-1', 'meta_key' => 'cena_od', 'orderby' => 'meta_value', 'order' => 'DESC'); ?>
    <?php } ?> 
