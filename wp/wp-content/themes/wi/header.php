...
})(window,document,'script','dataLayer','GTM-MNW9RQCM');</script>
<!-- End Google Tag Manager -->
</head>

<body <?php body_class(); ?> lang="<?php if (function_exists('icl_object_id')) { echo ICL_LANGUAGE_CODE; } ?>" path="<?php echo home_url(); ?>">
...
<!-- End Google Tag Manager (noscript) -->
                    ...
                    <ul class="sectionHeaderMenuUl sectionHeaderMenuUl2">
                        ...
                        <?php if( have_rows("socialmedia",wpmlID(2)) ) { ?>
                            <div class="sectionSocialMedia">
                                <?php while( have_rows("socialmedia",wpmlID(2)) ) { the_row(); ?>
        ...
        <div class="sectionTopbannerSubMenu">
            <div class="containerBig">
                <div class="sectionTopbannerSubMenuBox displaFlex flexWrap flexXbetween flexYcenter">
                    <?php while( have_rows("submenu_anchor") ) { the_row(); ?>
    ...
    <?php if ( is_front_page() || is_home() || get_field('topbanner_-_typ') == 1) { } else { ?>
            ...
            <div class="topBanner">
                <div class="containerBig">
                    <div class="topBannerContainer displayFlex flexWrap flexXstart flexYstretch">
                        ...
                        <?php if (get_post_type() == 'post') { } else { ?>
                            <div class="topBannerImg displayFlex flexXstart flexYcenter">
                                ...
                                <?php if (get_field('topbanner') != "") { ?> 
                                    <?php $topbanner = get_field('topbanner'); $topbanner = $topbanner["sizes"]["topbanner-712x440"]; ?>
                                <?php } ?>
