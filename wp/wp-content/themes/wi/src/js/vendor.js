...
!(function (t) {
    ...
    function e(t, i) {
        return void 0 === document.body.style.maxHeight
            ...
            ? void (t && t.length ? ((this.list = t), (this.num = t.length), this.initOptions(i), this.initialize()) : this.console.log("blueimp Gallery: No or empty list provided as first argument.", t))
            : new e(t, i);
    }
    return (
        t.extend(e.prototype, {
                ...
                function i() {
                    ...
                    document.body.appendChild(e),
                        s &&
                            ...
                            void 0 !== e.style[t] &&
                                ((e.style[t] = "translateZ(0)"), (i = window.getComputedStyle(e).getPropertyValue(s.prefix + "transform")), (o.transform = { prefix: s.prefix, name: t, translate: !0, translateZ: !!i && "none" !== i }))),
                ...
                if (i)
                    var s = this,
                        ...
                        n = window.setInterval(function () {
                            ...
                            if (l > i) return (s.slidesContainer[0].style.left = e + "px"), s.ontransitionend(), void window.clearInterval(n);
                            s.slidesContainer[0].style.left = (e - t) * (Math.floor((l / i) * 100) / 100) + t + "px";
                        }, 4);
            ...
            ontouchmove: function (t) {
                ...
                if (!(s.length > 1 || (o && 1 !== o)))
                    if (
                        ...
                        (this.touchDelta = { x: s.pageX - this.touchStart.x, y: s.pageY - this.touchStart.y }),
                        (e = this.touchDelta.x),
                        ...
                        for (
                            t.preventDefault(),
                                ...
                                this.options.continuous
                                    ...
                                    : ((this.touchDelta.x = e /= (!n && e > 0) || (n === this.num - 1 && e < 0) ? Math.abs(e) / this.slideWidth + 1 : 1), (i = [n]), n && i.push(n - 1), n < this.num - 1 && i.unshift(n + 1));
                            i.length;
            ...
            ontouchend: function (t) {
                ...
                this.options.continuous && (c = !1),
                    ...
                    this.isScrolling
                        ? u
                            ? this.close()
                            : this.translateY(l, 0, a)
                        : d && !c
                        ? ((i = l + e),
                          (s = l - e),
                          (o = r * e),
                          (n = -r * e),
                          this.options.continuous ? (this.move(this.circle(i), o, 0), this.move(this.circle(l - 2 * e), n, 0)) : i >= 0 && i < this.num && this.move(i, o, 0),
                          this.move(l, this.positions[l] + o, a),
                          this.move(this.circle(s), this.positions[this.circle(s)] + o, a),
                          (l = this.circle(s)),
                          this.onslide(l))
                        : this.options.continuous
                        ? (this.move(this.circle(l - 1), -r, a), this.move(l, 0, a), this.move(this.circle(l + 1), r, a))
                        : (l && this.move(l - 1, -r, a), this.move(l, 0, a), l < this.num - 1 && this.move(l + 1, r, a));
            },
            ...
            */
            ...
            oncomplete: function (e) {
                ...
                s &&
                    o &&
                    ((i = this.getNodeIndex(o)),
                    t(o).removeClass(this.options.slideLoadingClass),
                    "error" === e.type ? (t(o).addClass(this.options.slideErrorClass), (this.elements[i] = 3)) : (this.elements[i] = 2),
            ...
            handleClick: function (e) {
                ...
                i(s.toggleClass)
                    ...
                    ? s.closeOnSlideClick
                        ? (this.preventDefault(e), this.close())
                        : s.toggleControlsOnSlideClick && (this.preventDefault(e), this.toggleControls())
                    : n.parentNode && n.parentNode === this.slidesContainer[0] && s.toggleControlsOnSlideClick && (this.preventDefault(e), this.toggleControls());
            },
            onclick: function (t) {
            ...
            imageFactory: function (e, i) {
                ...
                return (
                    "string" != typeof h && ((h = this.getItemProperty(e, this.options.urlProperty)), (l = this.getItemProperty(e, this.options.titleProperty))),
                    !0 === d && (d = "contain"),
                    (d = this.support.backgroundSize && this.support.backgroundSize[d] && d) ? (n = this.elementPrototype.cloneNode(!1)) : ((n = r), (r.draggable = !1)),
                    l && (n.title = l),
                    t(r).on("load error", s),
                    (r.src = h),
                    n
            ...
            createElement: function (e, i) {
                ...
                return n || ((n = this.elementPrototype.cloneNode(!1)), this.setTimeout(i, [{ type: "error", target: n }])), l && n.setAttribute("srcset", l), t(n).addClass(this.options.slideContentClass), n;
            },
            loadElement: function (e) {
                this.elements[e] ||
                    (this.slides[e].firstChild
                        ? (this.elements[e] = t(this.slides[e]).hasClass(this.options.slideErrorClass) ? 3 : 2)
                        : ((this.elements[e] = 1), t(this.slides[e]).addClass(this.options.slideLoadingClass), this.slides[e].appendChild(this.createElement(this.list[e], this.proxyListener))));
            },
            ...
            getNestedProperty: function (t, e) {
                return (
                    e.replace(/\[(?:'([^']+)'|"([^"]+)"|(\d+))\]|(?:(?:^|\.)([^\.\[]+))/g, function (e, i, s, o, n) {
                ...
                if (
                    (e.dataset
                        ? ((s = i.replace(/-([a-z])/g, function (t, e) {
                          ...
                          (o = e.dataset[s]))
                        : e.getAttribute && (o = e.getAttribute("data-" + i.replace(/([A-Z])/g, "-$1").toLowerCase())),
                    "string" == typeof o)
                ) {
                    if (/^(true|false|null|-?\d+(\.\d+)?|\{[\s\S]*\}|\[[\s\S]*\])$/.test(o))
                        try {
            ...
            initOptions: function (e) {
                (this.options = t.extend({}, this.options)),
                    ((e && e.carousel) || (this.options.carousel && (!e || !1 !== e.carousel))) && t.extend(this.options, this.carouselOptions),
        ...
        return (
            t.extend(e.prototype, {
                createIndicator: function (e) {
                    ...
                    return (
                        this.options.thumbnailIndicators && (l && (i = this.getItemProperty(e, l)), void 0 === i && (s = e.getElementsByTagName && t(e).find("img")[0]) && (i = s.src), i && (o.style.backgroundImage = 'url("' + i + '")')),
                        n && (o.title = n),
                        o
                    );
                },
                ...
                setActiveIndicator: function (e) {
                    this.indicators &&
                        (this.activeIndicator && this.activeIndicator.removeClass(this.options.activeIndicatorClass), (this.activeIndicator = t(this.indicators[e])), this.activeIndicator.addClass(this.options.activeIndicatorClass));
                },
        ...
        return (
            t.extend(e.prototype, {
                ...
                videoFactory: function (e, i, s) {
                    ...
                    return (
                        v && ((y.poster = v), (o = this.imagePrototype.cloneNode(!1)), t(o).addClass(d.toggleClass), (o.src = v), (o.draggable = !1), c.appendChild(o)),
                        (l = document.createElement("a")).setAttribute("target", "_blank"),
        ...
        return (
            t.extend(s.prototype, {
                ...
                loadAPI: function () {
                    ...
                    i || ((i = document.createElement("script")).src = n), t(i).on("load", e), l[0].parentNode.insertBefore(i, l[0]), /loaded|complete/.test(i.readyState) && e();
                },
                onReady: function () {
                    var t = this;
                    (this.ready = !0),
            ...
            t.extend(e.prototype, {
                ...
                textFactory: function (t, e) {
                    ...
                    return l
                        ? (void 0 === this.getItemProperty(t, n.urlProperty) && (t[n.urlProperty] = "//vimeo.com/" + l), (o += 1), this.videoFactory(t, e, new s(n.vimeoPlayerUrl, l, n.vimeoPlayerIdPrefix + o, n.vimeoClickToPlay)))
                        : i.call(this, t, e);
                },
            }),
            e
        ...
        return (
            ...
            t.extend(e.prototype, {
                ...
                textFactory: function (t, e) {
                    ...
                    return n
                        ? (void 0 === this.getItemProperty(t, o.urlProperty) && (t[o.urlProperty] = "//www.youtube.com/watch?v=" + n),
                          void 0 === this.getItemProperty(t, o.videoPosterProperty) && (t[o.videoPosterProperty] = "//img.youtube.com/vi/" + n + "/maxresdefault.jpg"),
                          this.videoFactory(t, e, new s(n, o.youTubePlayerVars, o.youTubeClickToPlay)))
                        : i.call(this, t, e);
                },
            }),
            e
...
;(function(factory) {
    ...
    Slick.prototype.setDimensions = function() {
        ...
        if (_.options.vertical === false && _.options.variableWidth === false) {
            ...
            _.$slideTrack.width(5000 * _.slideCount * 1.5);
        } else {
